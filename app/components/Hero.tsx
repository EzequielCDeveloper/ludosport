    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 text-center pt-24 pb-16">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 hero__animation--ctas">
          ...
          <a
            href="#actividades"
            className="inline-block font-display text-base uppercase tracking-wider text-white border-2 border-white hover:bg-white hover:text-black px-8 py-3 transition-all duration-300 hover:scale-[1.05] active:scale-[0.97]"
          >
            Ver actividades
          </a>
        </div>
