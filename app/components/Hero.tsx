  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 text-center pt-24 pb-16">
        ...
        {/* Subtitle */}
        <p className="font-body text-lg sm:text-xl text-white max-w-2xl mx-auto mb-4 text-center hero__animation--subtitle">
          Esgrima deportiva con sables de madera — disciplina, respeto y dominio
          personal
        </p>

        <p className="font-body text-sm sm:text-base text-white max-w-2xl mx-auto mb-4 text-center hero__animation--age">
